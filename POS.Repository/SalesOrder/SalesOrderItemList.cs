            ...
            if (pageSize == 0)
            {
                var entities = await source
                             ...
                             .Select(c => new SalesOrderItemDto
                             {
                                 ...
                                 Quantity = c.Quantity,
                                 //PurPrice = decimal.Round(Math.Round((decimal)c.Product.PurchasePrice.Value) * c.Quantity),
                                 //PurPrice = (decimal)Math.Round(c.Product.PurchasePrice.Value) * c.Quantity,
                                 PurPrice = c.TotalPurPrice.Value,
